...
###csv data준비###
post <- read.csv("C:/Users/joanl/BAC_project/R분석/210227company_post_3차.csv",header=T)
profile <- read.csv("C:/Users/joanl/BAC_project/R분석/210227company_profile_3차.csv",header=T)
...
#엑셀 파일로 뽑기
setwd('C:/Users/joanl/BAC_project/R분석')
